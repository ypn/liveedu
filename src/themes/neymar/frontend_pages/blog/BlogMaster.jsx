              ...
              list.map((node,key)=>{
                return(
                  <Card className={classes.card}>
                    ...
                    />
                    <div>
                      <img style={{width:'100%',height:180,objectFit:'cover'}} src="https://images.pexels.com/photos/583846/pexels-photo-583846.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" />
                    </div>
                    <CardContent>
                      <Typography variant="title" className={classes.post_title}>Tại sao mây lại màu trắng?</Typography>
