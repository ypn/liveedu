          ...
          <NavLink to="/live"><Button color="inherit">trực tiếp<Icon style={{marginLeft:3,color:'red'}}>surround_sound</Icon></Button></NavLink>
            ...
            {auth && (
              <div>
                ...
                >
                  <MenuItem onClick={this.handleClose}>Trang cá nhân</MenuItem>
                  <MenuItem onClick={this.handleClose}>Quản lý giảng viên</MenuItem>
                  <MenuItem onClick={this.handleClose}>Cài đặt</MenuItem>
